...
2. Create a vector of numbers (with length 21) to store the number of days in each of 2000, 2001, ..., 2020 has Olympic Games. Store the answer in a variable named `ndays` and print.
...
2. Find the species of the 5 largest penguins in terms of body mass. 
