...
We stop the algorithm if the sum changes by less than $10^{-5}$ as we double the number of terms
```{r}
tolerance <- 1e-5
...
- The `for`, `while`, and `repeat` loops are mostly interchangable. There are always more than one way to perform the task (with the conditional/control flow statements)
