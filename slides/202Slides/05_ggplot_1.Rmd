...
<!--  -->
<!-- Write down questions that you could answer with this data by yourself (4 minutes), then discuss in pairs (3 minutes), and we'll write ideas on the board -->
...
<img src="images/blue.png" width=20> Use barchart to represent the state populations. <br/>
<img src="images/green.png" width=20> Draw a scatterplot of the number of burglaries by murders.<br/>
<img src="images/blue.png" width=20> Adjust the numbers of the above scatterplot to show log transformed numbers. How can we interpret the numbers on the axes?<br/>
<img src="images/blue.png" width=20> Draw a scatterplot of the log transformed number of burglaries by motor vehicle thefts. Map the state variable to colour. Why is this a terrible idea?<br/>
<img src="images/blue.png" width=20> Draw a scatterplot of the log transformed number of burglaries by motor vehicle thefts. Map Population to size. How do we interpret the output?<br/>
