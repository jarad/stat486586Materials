...
<!-- - What does the x-axis (data score) consist of? -->
<!--  -->
<!-- - What information is being showed, through what plot elements? -->
<!--  -->
<!-- - Do you like the visualization or not? Why is it good (or bad)? -->
<!--  -->
<!-- - How could you reproduce it in ggplot2? (HW6) -->
<!--  -->
...
<!-- - What graph elements are used, and what information do they display? -->
<!--  -->
