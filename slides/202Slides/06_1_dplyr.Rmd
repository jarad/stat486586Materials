...
- share common data representations and API (application programming interface), i.e. work well together
...
Functions in `tidyverse` have `data` as their first argument. E.g.,
...
## Your turn: distinct, summarize, group_by, and arrange. {.white}

<img class="cover" src="images/blue.jpeg" alt="" width=2000>


<img src="images/blue.png" width=20> What is the population of each state in 2017? Remove redundant information using `distinct`. </br>
