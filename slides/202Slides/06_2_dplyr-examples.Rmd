...
<!-- For this your turn import the "Defensive" sheet from  `cyclonesFootball2020.xlsx` into R and name the data frame `defense`. What does each column stand for?  -->
...
<!-- <img class="cover" src="images/blue.jpeg" alt="" width=2000> -->
<!--  -->
<!-- <img src="images/blue.png" width=20> What else can be answered from this data? -->
